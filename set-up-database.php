...
try{
	...
	$lQueryString = "INSERT INTO youTubeVideos(recordIndetifier, identificationToken, title) 
		VALUES
			...
			(31, 'sTTdFujJIAA', 'Two Methods to Steal Session Token using Cross-Site Scripting'),
			(32, 'DXtLNGqfgMo', 'Injecting a Cross Site Script via Cascading Stylesheet Context'),
			(33, 'C_3I6IpbP78', 'Basics of Injecting Cross-Site Script into HTML onclick Event'),
			(34, 'XnOqNCd31B4', 'Introduction to locating Reflected Cross-site Scripting'),
			(35, 'dIGJ7kuj9Qo', 'Sending Persistent Cross-site Scripts into Web Logs to Snag Web Admin'),
			(37, 'bj9IcclYG1k', 'Injecting Cross Site Scripts (XSS) into Log Page via Cookie'),
			(38, 'efHdM5grGkI', 'Introduction to HTML Injection (HTMLi) and Cross Site Scripting (XSS) Using Mutillidae'),
			(39, 'zs30qw4CF2U', 'Introduction to Cross Site Scripting (XSS) via JavaScript String Injection'),
			(41, 'uJoMHujjo_I', 'Adding Values to DOM Storage using Cross-site Scripting'),
			(42, 'N1-FXp7WrC4', 'Alter Values in HTML5 Web Storage using Cross-site Script'),
			(43, 'F4I9XfTAsJk', 'Alter Values in HTML5 Web Storage using Persistent Cross-site Script'),
			(44, 'luMyYV70bk4', 'Alter Values in HTML5 Web Storage using Reflected Cross-site Script '),
			...
			(47, '3nAqRp9wt8g', 'Reading Hidden Values from HTML5 Dom Storage'),
			...
			(64, '9EaNr_8D65A', 'XSS bypassing JavaScript Validation'),
